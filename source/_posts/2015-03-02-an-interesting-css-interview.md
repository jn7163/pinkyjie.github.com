...
{% img center-img http://pinkyjie-blog.qiniudn.com/images/an-interesting-css-interview-1.png 图1 %}
...
{% img center-img http://pinkyjie-blog.qiniudn.com/images/an-interesting-css-interview-2.png 图2 %}
...
{% img center-img http://pinkyjie-blog.qiniudn.com/images/an-interesting-css-interview-3.png 图3 %}
...
{% img center-img http://pinkyjie-blog.qiniudn.com/images/an-interesting-css-interview-4.png 图4 %}
...
{% img center-img http://pinkyjie-blog.qiniudn.com/images/an-interesting-css-interview-5.png 图5 %}
...
{% img center-img http://pinkyjie-blog.qiniudn.com/images/an-interesting-css-interview-6.png 图6 %}
...
{% img center-img http://pinkyjie-blog.qiniudn.com/images/an-interesting-css-interview-7.png 图7 %}
...
{% img center-img http://pinkyjie-blog.qiniudn.com/images/an-interesting-css-interview-8.png 图8 %}
...
{% img center-img http://pinkyjie-blog.qiniudn.com/images/an-interesting-css-interview-9.png 图9 %}
...
{% img center-img http://pinkyjie-blog.qiniudn.com/images/an-interesting-css-interview-10.png 图10 %}
...
{% img center-img http://pinkyjie-blog.qiniudn.com/images/an-interesting-css-interview-11.png 图11 %}
...
{% img center-img http://pinkyjie-blog.qiniudn.com/images/an-interesting-css-interview-12.png 图12 %}

这一步应该是最复杂的一步了，起初看到这个按钮图，可能就只能注意到最外面的一个边框。其实，如果在不改变HTML的情况，最外面的几层都只能通过边框来实现，通过下面这个放大后的图我们应该就可以非常清晰的看到这四层边框。

{% img center-img http://pinkyjie-blog.qiniudn.com/images/an-interesting-css-interview-13.png 图13 %}
...
{% img center-img http://pinkyjie-blog.qiniudn.com/images/an-interesting-css-interview-14.png 图14 %}
...
到这里，大致的效果已经被还原了（当然，如果考虑浏览器兼容性，很多样式都要多写几条的，你懂得！）。之所以说大致还原，是因为对于效果图还有很多不足：很多颜色不够准确，阴影的范围也不逼真，还有一点关键的就是：分界背景的下半段的两边是有一丝弧度的，这个我目前为止还是不知道怎么实现。。。最最变态的是，这道题的要求是15分钟，我估计做了好几个小时了吧O(∩_∩)O~ 在CSS的不归路上还有很多路要走啊。。。
