...
书接[上回](/2014/08/03/git-notes-part-2/)，直入主题！这篇继续实践剩下的几个命令。

<!--more-->

现在的SourceTree状态如下：

{% img center-img http://pinkyjie-blog.qiniudn.com/images/git-notes-24.png 图24 %}
...
{% img center-img http://pinkyjie-blog.qiniudn.com/images/git-notes-25.png 图25 %}
...
{% img center-img http://pinkyjie-blog.qiniudn.com/images/git-notes-26.png 图26 %}

确定这两个commit被复制到指定分支以后，在master分支上将这两个commit删除。先切回master分支：`git checkout master`，运行`git reset --hard 1a222c3`，此时SourceTree的状态图为：

{% img center-img http://pinkyjie-blog.qiniudn.com/images/git-notes-27.png 图27 %}
...
{% img center-img http://pinkyjie-blog.qiniudn.com/images/git-notes-28.png 图28 %}
...
{% img center-img http://pinkyjie-blog.qiniudn.com/images/git-notes-29.png 图29 %}
...
{% img center-img http://pinkyjie-blog.qiniudn.com/images/git-notes-30.png 图30 %}
...
{% img center-img http://pinkyjie-blog.qiniudn.com/images/git-notes-31.png 图31 %}
...
{% img center-img http://pinkyjie-blog.qiniudn.com/images/git-notes-32.png 图32 %}
...
{% img center-img http://pinkyjie-blog.qiniudn.com/images/git-notes-33.png 图33 %}
...
{% img center-img http://pinkyjie-blog.qiniudn.com/images/git-notes-34.png 图34 %}
...
{% img center-img http://pinkyjie-blog.qiniudn.com/images/git-notes-35.png 图35 %}
...
{% img center-img http://pinkyjie-blog.qiniudn.com/images/git-notes-36.png 图36 %}

{% img center-img http://pinkyjie-blog.qiniudn.com/images/git-notes-37.png 图37 %}
...
{% img center-img http://pinkyjie-blog.qiniudn.com/images/git-notes-38.png 图38 %}

选中这条commit，点击红框中的“Edit message”，出现了更改commit信息的对话框，如下图：

{% img center-img http://pinkyjie-blog.qiniudn.com/images/git-notes-39.png 图39 %}

输入“commit 10,11”即可，点击OK保存，再次点击OK完成此次rebase。此时SourceTree的状态如图40所示：

{% img center-img http://pinkyjie-blog.qiniudn.com/images/git-notes-40.png 图40 %}
