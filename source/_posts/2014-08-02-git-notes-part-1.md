...
{% img center-img http://pinkyjie-blog.qiniudn.com/images/git-notes-1.png 图1 %}
...
{% img center-img http://pinkyjie-blog.qiniudn.com/images/git-notes-2.png 图2 %}
...
{% img center-img http://pinkyjie-blog.qiniudn.com/images/git-notes-3.png 图3 %}
...
{% img center-img http://pinkyjie-blog.qiniudn.com/images/git-notes-4.png 图4 %}
...
{% img center-img http://pinkyjie-blog.qiniudn.com/images/git-notes-5.png 图5 %}

{% img center-img http://pinkyjie-blog.qiniudn.com/images/git-notes-6.png 图6 %}
...
{% img center-img http://pinkyjie-blog.qiniudn.com/images/git-notes-7.png 图7 %}

{% img center-img http://pinkyjie-blog.qiniudn.com/images/git-notes-8.png 图8 %}
...
{% img center-img http://pinkyjie-blog.qiniudn.com/images/git-notes-9.png 图9 %}
...
{% img center-img http://pinkyjie-blog.qiniudn.com/images/git-notes-10.png 图10 %}
...
{% img center-img http://pinkyjie-blog.qiniudn.com/images/git-notes-11.png 图11 %}

按照Git给的提示，此时我们checkout到别的地方去：`git checkout master`切回master分支，再去SourceTree看一眼，我擦泪，刚才的修改丢了！！如下图：

{% img center-img http://pinkyjie-blog.qiniudn.com/images/git-notes-12.png 图12 %}
...
{% img center-img http://pinkyjie-blog.qiniudn.com/images/git-notes-14.png 图14 %}
